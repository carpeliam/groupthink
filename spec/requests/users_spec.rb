...
describe "resource(:users)", :given => "a user is logged in" do
  describe "GET" do
...
describe "resource(@user)" do 
  describe "a successful DELETE", :given => "a user is logged in" do
     before(:each) do
...
describe "resource(@user, :edit)", :given => "a user is logged in" do
  before(:each) do
...
describe "resource(@user)", :given => "a user exists" do
  ...
  describe "PUT", :given => "a user is logged in" do
    before(:each) do
      @user = User.first
